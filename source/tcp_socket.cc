/*
 *   Adapted 2018 by Abdullah Waqar
 *
...
TCPSocket::TCPSocket(int type, int protocol) : Socket(type, protocol) {
}
...
TCPSocket::TCPSocket() : TCPSocket(SOCK_STREAM, IPPROTO_TCP) {}

TCPSocket::TCPSocket(const string &foreignAddress, unsigned short foreignPort) : TCPSocket(SOCK_STREAM, IPPROTO_TCP) {
